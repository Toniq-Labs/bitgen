 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class lo extends _e{constructor(t){if(super(t),this.it=U,t.type!==xn.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===U||t==null)return this._t=void 0,this.it=t;if(t===de)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}lo.directiveName="unsafeHTML",lo.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,rf=w({name:"LoaderAnimated24Icon",svgTemplate:h`
    ...
    `});var Xn;(function(e){e.Loading="loading",e.Error="error"})(Xn||(Xn={}));const Cn=Ft()({tagName:"vira-image",hostClasses:{"vira-image-height-constrained":({inputs:e})=>e.dominantDimension==="height"},events:{imageLoad:q(),imageError:q()},styles:({hostClasses:e})=>v`
        :host {
            display: inline-flex;
            overflow: hidden;
            flex-direction: column;
...
`;w({name:"CryptoIcp16Icon",svgTemplate:h`
    ...
    `}),If=w({name:"BioniqRobot100Icon",svgTemplate:h`
        <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    `});const Cf=Be({discord:Ie(void 0,""),distrikt:Ie(void 0,""),dscvr:Ie(void 0,""),instagram:Ie(void 0,""),medium:Ie(void 0,""),telegram:Ie(void 0,""),tikTok:Ie(void 0,""),twitch:Ie(void 0,""),twitter:Ie(void 0,""),website:Ie(void 0,"")});Cf.defaultValue;const Mf={discord:yf,instagram:$f,telegram:Tf,tikTok:Sf,distrikt:bf,twitch:Ef,dscvr:kf,medium:xf,twitter:Af,website:wf},pa="toniq-",{defineElement:B,defineElementNoInputs:di}=vl({assertInputs:e=>{if(!e.tagName.startsWith(pa))throw new Error(`Tag name should start with '${pa}' but got '${e.tagName}'`)}}),Lr=B()({tagName:"toniq-bold-space",styles:v`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e}){function t(r){if(e.linkType===Pe.Disabled){r.preventDefault();return}e.linkType===Pe.RouteLink&&ci(r)&&(r.preventDefault(),e.scrollToTop&&window.scrollTo(0,0))}const n=e.linkType===Pe.NewTab;return h`
        ...
        `}}),Ao=360,Nc=8;function Oc(e){return(e-Nc)/2}const Ce=He({"main-image-size":Ao,"secondary-image-size":Oc(Ao)}),Le=B()({tagName:"toniq-featured-flip-card-footer",styles:v`
        :host {
            display: inline-flex;
        ...
        ${R} {
            flex-grow: 2;
            white-space: nowrap;
            max-width: calc(${Ce["secondary-image-size"].value} * 2);
        }
        ...
        .more-info-button {
            flex-grow: 1;
            max-width: ${Ce["secondary-image-size"].value};
        }
    ...
    `,renderCallback({inputs:e,dispatch:t,events:n}){return h`
        ...
        .all-images {
            ...
            overflow: hidden;
            max-height: ${Ce["main-image-size"].value};
            justify-content: space-evenly;
            gap: 2px;
        }

        .secondary-images {
            flex-basis: ${Ce["secondary-image-size"].value};
            justify-content: space-evenly;
            row-gap: ${Nc}px;
            column-gap: 2px;
            flex-grow: 1;
        ...
        .main-image-wrapper {
            width: ${Ce["main-image-size"].value};
            height: ${Ce["main-image-size"].value};
        }

        .secondary-image-wrapper {
            width: ${Ce["secondary-image-size"].value};
            height: ${Ce["secondary-image-size"].value};
        }
    ...
    `,renderCallback({inputs:e,state:t,updateState:n,host:r,dispatch:o,events:i}){var m,p,g,y;const a=e.mainImageSize||Ao,s=Oc(a);co({onElement:r,forCssVar:Ce["main-image-size"],toValue:`${a}px`}),co({onElement:r,forCssVar:Ce["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter(yt).join(" "),c=h`
            <h3>${e.cardTitle}</h3>
        `,u=e.imageUrls[0],f=u?h`
                  <div class="main-image-wrapper">
                      ${((m=e.customTemplateCallback)==null?void 0:m.call(e,u))||h`
                          <${Cn.assign({imageUrl:u})}></${Cn}>
                      `}
                  </div>
              `:"";return h`
    ...
    `,renderCallback({inputs:e}){return e.level===ee.H1?h`
            ...
            `:h`
                <slot></slot>
            `}});function Io({input:e,matcher:t}){return!e||!t?!0:e.length>1?!!e.split("").every(n=>Io({input:n,matcher:t})):t instanceof RegExp?!!e.match(t):t.includes(e)}function Pc({value:e,allowed:t,blocked:n}){const r=t?Io({input:e,matcher:t}):!0,o=n?Io({input:e,matcher:n}):!1;return r&&!o}function ts(e){if(!e.value)return{filtered:e.value,blocked:""};const{filtered:t,blocked:n}=e.value.split("").reduce((r,o)=>(Pc({...e,value:o})?r.filtered.push(o):r.blocked.push(o),r),{filtered:[],blocked:[]});return{filtered:t.join(""),blocked:n.join("")}}var Co;(function(e){e.Default="default",e.Outline="outline"})(Co||(Co={}));const Dn=B()({tagName:"toniq-input",hostClasses:{"toniq-input-outline":({inputs:e})=>e.variant===Co.Outline,"toniq-input-has-a-value":({inputs:e})=>!!e.value,"toniq-input-disabled":({inputs:e})=>!!e.disabled},events:{valueChange:q(),inputBlock:q()},styles:({hostClasses:e})=>v`
            :host {
                position: relative;
                display: inline-flex;
                width: 224px;
    ...
    `,hostClasses:{"toniq-middle-ellipsis-clickable":({inputs:e})=>!!e.externalLink||!!e.copyOnClick},stateInitStatic:{showCopiedTextTimeoutId:void 0},renderCallback({inputs:e,dispatch:t,events:n,state:r,updateState:o}){if(!e.text)return h``;const i=e.text,a=y0(e),s=!!e.externalLink,l=!!e.copyOnClick,c=i.length>a*2+2,u=c?v0(i,a):i,f=c?i:"",m=s?hf:l?Sl:void 0,p=m?h`
        ...
        `;return u?s?h`
                    <button
                        tabindex="0"
                        role="link"
                        ${T("click",y=>{var $,I;const x=(I=($=y.currentTarget)==null?void 0:$.querySelector)==null?void 0:I.call($,"a");if(!x)throw new Error("Failed to find link anchor tag for middle ellipsis element link.");x.click()})}
                        class="link-wrapper"
                    >
                        <!--
    ...
    `,renderCallback({inputs:e,cssVars:t,host:n}){const r=ft({value:e.percent,max:100,min:0}),o=`${r}%`;return co({forCssVar:t["toniq-progress-width"],onElement:n,toValue:o}),n.setAttribute("title",`${o} finished`),r?h`
            ...
            `:U}});const k0=B()({tagName:"toniq-radio-group",stateInitStatic:{randomGroupName:""},events:{valueChange:q()},cssVars:{"toniq-radio-group-unchecked-radio-color":String(Se("pagePrimary","foregroundColor")),"toniq-radio-group-unchecked-label-color":String(Se("pagePrimary","foregroundColor")),"toniq-radio-group-checked-radio-color":String(Se("accentPrimary","backgroundColor")),"toniq-radio-group-checked-label-color":String(Se("pageInteraction","foregroundColor"))},styles:({cssVars:e})=>v`
        :host {
            ${j.boldParagraphFont};
            display: inline-flex;
            transition:
...
`;function rn(e){requestAnimationFrame(()=>{const t=qc(e.instanceInputs,e).elementValue;N0(t,e)&&(e.setAttribute("disabled","true"),rn(e))})}B()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:q()},styles:v`
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{rn(e)}),e.addEventListener("keydown",()=>{rn(e)}),e.addEventListener("keyup",()=>{rn(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:o,updateState:i}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:u,elementLimits:f,rangeWidth:m}=qc({...e},t);if(rn(t),bn(u))return p(a,u,f);return y(a,u,f);function p(x,$,I){const z={left:Te((m-ct)*($.min-I.min)/(I.max-I.min)+ct/2),right:Te((m-ct)*(I.max-$.max)/(I.max-I.min)+ct/2)},X=Zr(x.min,c,l),be=Zr(x.max,c,l);requestAnimationFrame(()=>{const Ve=A0(t);Ve!==o.labelOverlap&&i({labelOverlap:Ve})});const nt=(I.max-$.max)/(I.max-I.min)>.5,jt=zr({value:$.min,limits:{min:I.min,max:$.max},flip:!0}),Ut=zr({value:$.max,limits:{min:$.min,max:I.max},flip:!1}),Gt=o.labelOverlap&&nt?o.labelOverlap:0,rt=o.labelOverlap&&!nt?o.labelOverlap:0;return h`
                <div
                    class="range"
            ...
            `}function g(x){i({internalValue:x}),e.disabled||r(new n.valueChange(x))}function y(x,$,I){const z=Te((m-ct)*(I.max-$)/(I.max-I.min)+ct/2),X=Zr(x,c,l),be=zr({value:$,limits:I,flip:!1});return h`
                <div
                    class="range"
                    ${vn(()=>{i({rangeWidth:Mo(t)})})}
                >
...
`;function Q0(e){return[{title:"Inscription HTML",subtitle:"Example that has all traits set to 0.",code:X0(e)},{title:"Collection JSON",code:JSON.stringify({collection:{...e.collection,collectionImageInscriptionId:e.ids.collectionImageInscriptionId},layers:e.layers},null,4)},{title:"Collection JS",code:ep(e)},{title:"Provenance JSON",code:JSON.stringify({bitcoinAddress:e.ids.bitcoinAddress||"BITCOIN-ADDRESS-HERE",collectionJsonInscriptionId:e.ids.collectionJsonInscriptionId||"COLLECTION-JSON-INSCRIPTION-ID-HERE",excludeInscriptions:["EXCLUDE-INSCRIPTIONS-HERE"]},null,4)},{title:"Renderer JS",subtitle:"This will never change. You can inscribe this once for all BitGen collections you ever make or use an already-inscribed copy (at your own risk).",code:tp()}]}function X0(e){return`<script t="${e.layers.map(()=>0).join(",")}" src="/content/{collection-js-inscription-id-here}"><\/script>`}function ep(e){const t=e.ids.collectionJsonInscriptionId||"COLLECTION-JSON-INSCRIPTION-ID-HERE",n=e.ids.rendererJavascriptInscriptionId||"RENDERER-JS-INSCRIPTION-ID-HERE";return`// edit these values
const myValues = {
    ...
    `,renderCallback(){return h`
            <div class="wrapper">
                <div class="icon-wrapper">
                    <${N.assign({icon:If,fitContainer:!0})}></${N}>
                </div>
...
`,ap=Jn(ip).replace(/\n+/g," ").replace(/'/g,"\\'");var Cs;const sp=h(Cs||(Cs=Mi([`
    <script>
...
`,As=B()({tagName:"toniq-bitgen-collection-info-display",styles:v`
    ...
    `,renderCallback({inputs:e}){return h`
            <${K.assign({level:ee.H2})}>
                ${e.bitgenCollection.collection.name}
            </${K}>
