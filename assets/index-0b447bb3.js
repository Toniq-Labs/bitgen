...
`;w({name:"CryptoIcp16Icon",svgTemplate:h`
    ...
    `});const Yf=w({name:"BrandInstagram24Icon",svgTemplate:h`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill-rule="evenodd"
            width="24"
    ...
    `});const Jf=w({name:"BrandMedium24Icon",svgTemplate:h`
        <svg
            xmlns="http://www.w3.org/2000/svg"
            stroke="none"
            fill=${H["toniq-icon-fill-color"]("#000")}
    ...
    `});const nh=Be({discord:xe(void 0,""),distrikt:xe(void 0,""),dscvr:xe(void 0,""),instagram:xe(void 0,""),medium:xe(void 0,""),telegram:xe(void 0,""),tikTok:xe(void 0,""),twitch:xe(void 0,""),twitter:xe(void 0,""),website:xe(void 0,"")});nh.defaultValue;const rh={discord:Uf,instagram:Yf,telegram:Kf,tikTok:Qf,distrikt:Zf,twitch:Xf,dscvr:Gf,medium:Jf,twitter:eh,website:jf},Ta="toniq-",{defineElement:P,defineElementNoInputs:vo}=Ll({assertInputs:e=>{if(!e.tagName.startsWith(Ta))throw new Error(`Tag name should start with '${Ta}' but got '${e.tagName}'`)}}),Br=P()({tagName:"toniq-bold-space",styles:v`
        :host {
            display: inline-flex;
            position: relative;
        }
    ...
    `,renderCallback({inputs:e,state:t,updateState:n,host:r,dispatch:i,events:o}){var m,p,g,b;const a=e.mainImageSize||Oi,s=Zc(a);pi({onElement:r,forCssVar:Ae["main-image-size"],toValue:`${a}px`}),pi({onElement:r,forCssVar:Ae["secondary-image-size"],toValue:`${s}px`});const l=["View",e.viewButtonTitle].filter($t).join(" "),c=h`
        ...
        `}});var J;(function(e){e.H1="h1",e.H2="h2",e.H3="h3",e.H4="h4"})(J||(J={}));const z=P()({tagName:"toniq-heading",hostClasses:{"toniq-heading-h1":({inputs:e})=>e.level===J.H1,"toniq-heading-h2":({inputs:e})=>e.level===J.H2,"toniq-heading-h3":({inputs:e})=>e.level===J.H3,"toniq-heading-h4":({inputs:e})=>e.level===J.H4},styles:({hostClasses:e})=>v`
    ...
    `,renderCallback({inputs:e}){return e.level===J.H1?h`
                <h1><slot></slot></h1>
            `:e.level===J.H2?h`
                <h2><slot></slot></h2>
            `:e.level===J.H3?h`
    ...
    `,initCallback:({updateState:e})=>{e({randomGroupName:fr()})},renderCallback({inputs:e,dispatch:t,events:n,state:r}){return Y0(e.entries).map(o=>J0(e.groupName||r.randomGroupName,e.value,o,()=>{t(new n.valueChange(o.value))}))}});function Y0(e){const t=Object.fromEntries(e.map(r=>[r.value,r]));return Object.values(t).length!==e.length&&console.error(`${G0.tagName} was given duplicate entry values.`),Object.values(t)}function J0(e,t,n,r){const i=t===n.value,o=h`
...
`,ps=v`
    transform: scale(1.2);
`;function sn(e){requestAnimationFrame(()=>{const t=Yc(e.instanceInputs,e).elementValue;o1(t,e)&&(e.setAttribute("disabled","true"),sn(e))})}P()({tagName:"toniq-slider",stateInitStatic:{rangeWidth:0,labelOverlap:0,internalValue:-1},events:{valueChange:q()},styles:v`
        :host {
            display: block;
        }
    ...
    `,initCallback:({host:e})=>{e.addEventListener("mousemove",()=>{sn(e)}),e.addEventListener("keydown",()=>{sn(e)}),e.addEventListener("keyup",()=>{sn(e)})},renderCallback({inputs:e,host:t,events:n,dispatch:r,state:i,updateState:o}){const{actualValue:a,logRange:s,isLogScale:l,suffix:c,elementValue:d,elementLimits:u,rangeWidth:m}=Yc({...e},t);if(sn(t),Tn(d))return p(a,d,u);return b(a,d,u);function p(x,k,A){const U={left:Te((m-dt)*(k.min-A.min)/(A.max-A.min)+dt/2),right:Te((m-dt)*(A.max-k.max)/(A.max-A.min)+dt/2)},ee=Kr(x.min,c,l),be=Kr(x.max,c,l);requestAnimationFrame(()=>{const ze=e1(t);ze!==i.labelOverlap&&o({labelOverlap:ze})});const rt=(A.max-k.max)/(A.max-A.min)>.5,Zt=Jr({value:k.min,limits:{min:A.min,max:k.max},flip:!0}),Gt=Jr({value:k.max,limits:{min:k.min,max:A.max},flip:!1}),Yt=i.labelOverlap&&rt?i.labelOverlap:0,it=i.labelOverlap&&!rt?i.labelOverlap:0;return h`
                <div
                    class="range"
            ...
            `}function g(x){o({internalValue:x}),e.disabled||r(new n.valueChange(x))}function b(x,k,A){const U=Te((m-dt)*(A.max-k)/(A.max-A.min)+dt/2),ee=Kr(x,c,l),be=Jr({value:k,limits:A,flip:!1});return h`
                <div
                    class="range"
                    ${yn(()=>{o({rangeWidth:qi(t)})})}
                >
...
`,Hs=P()({tagName:"toniq-bitgen-collection-info-display",styles:v`
    ...
    `}const wg={creator:"Creator",description:"Description",name:"Name"},bg={bitcoinAddress:"Bitcoin Receiving Address",collectionImageInscriptionId:"Image Inscription Id",collectionJsonInscriptionId:"Collection JSON Inscription Id",rendererJavascriptInscriptionId:"Renderer JS Inscription Id"},ct=P()({tagName:"toniq-bitgen-collection-nav",styles:v`
        ${kr}
    ...
    `,events:{selectionChange:q(),collectionCreate:q(),collectionDelete:q(),editRawTrigger:q()},renderCallback({inputs:e,dispatch:t,events:n}){const r=Vu(e.bitgenCollections,i=>i.editId,(i,o)=>h`
            ...
            <div class="nav-header">
                <${z.assign({level:J.H4})}>Collections</${z}>
                <${_.assign({icon:go,variant:le.Secondary})}
    ...
    `,stateInitStatic:{currentBitgenCollections:ho(),selectedBitgenCollectionIndex:0,editRaw:!1},initCallback({inputs:e,state:t}){t.currentBitgenCollections.setNewPromise(e.webClientInterface.collectionStorage.loadStoredBitgenCollections())},renderCallback({state:e,inputs:t,updateState:n}){async function r(s){await t.webClientInterface.collectionStorage.storeBitgenCollections(s),e.currentBitgenCollections.setResolvedValue(s)}if(Ml(e.currentBitgenCollections.value)){if(gi(e.currentBitgenCollections.value)||e.editRaw||!ol(e.currentBitgenCollections.value,xs)){const s=gi(e.currentBitgenCollections.value)?h`
            ...
            `;const i=e.currentBitgenCollections.value;if(!Ui(i,1))return h`
                <${Je}>No collections to edit.</${Je}>
            `;const o=i[e.selectedBitgenCollectionIndex]||i[0];async function a(s){const l=ur(i),c=s(l)||l;await r(c)}return h`
            <main
                ${T(Mo,async s=>{await a(l=>{const c=Js(o,s.detail);l[e.selectedBitgenCollectionIndex]=c})})}
            >
                <section>
